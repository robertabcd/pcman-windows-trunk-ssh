...
void CGeneralPage::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_MINIDUMP, m_minidump);
}
...
BOOL CGeneralPage::OnInitDialog()
{
	...
	CheckDlgButton(IDC_CLOSEOTHER_QUERY, AppConfig.closeother_query);
	...
	CheckDlgButton(IDC_NT_IN_NWT_RIGHT,AppConfig.m_bNewTab_InNowTabNei);
	...
	m_minidump.AddString(LoadString(IDS_NONE));
	m_minidump.AddString(LoadString(IDS_MINIDUMP_TYPE_NORMAL));
	m_minidump.AddString(LoadString(IDS_MINIDUMP_TYPE_WITHDATA));
	m_minidump.AddString(LoadString(IDS_MINIDUMP_TYPE_WITHFULL));
	m_minidump.SetCurSel(AppConfig.minidump_type);
...
void CGeneralPage::OnOK()
{
	...
	AppConfig.closeother_query = IsDlgButtonChecked(IDC_CLOSEOTHER_QUERY);
	...
	AppConfig.m_bNewTab_InNowTabNei = IsDlgButtonChecked(IDC_NT_IN_NWT_RIGHT);
	AppConfig.minidump_type = m_minidump.GetCurSel();
#ifdef	_COMBO_
